...
class MongoDBCollection:
    ...
    def get_collection():
        if not MongoDBCollection.collection:
            ...
            database = client.get_database('rpgks') # TODO <<alterar valor>>
            MongoDBCollection.collection = database.get_collection('item') # TODO <<alterar valor>>
...
class Neo4jDriver:
    ...
    neo4j_password = "12345678" # TODO <<alterar valor>>
...
class CharacterDAO:
    ...
    def add_character(self, character: Character):
        ...
        # Liga o personagem a profissões
    ...
    def get_knowledge(self, character_name):
        # Obtém o as páginas que o perdonagem conhece
        with self.neo4j_driver.session() as session:
            result = session.run(
                """
